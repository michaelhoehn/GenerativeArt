...
const house01 = (p5, x, y, scale) => {
  ...
  // call windows within a for loop n times as determined by this function
...
const placeWindows = (p5, x, y, hWidth, hHeight, scale) => {
  // call place windows n times within the draw house functions
  // this makes it easier for the checking of overlapping windows
